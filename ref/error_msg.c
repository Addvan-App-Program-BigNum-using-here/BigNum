...
static char *error_msg_list[6][10] = {{"SUCCESS", "FAIL"},
                                      ...
                                      {"BI_GET_RANDOM_SUCCESS", "BI_GET_RANDOM_FAIL", "GEN_RANDOM_SUCCESS", "GEN_RANDOM_FAIL", "BI_SET_REFINE_SUCCESS", "BI_SET_REFIEN_FAIL", "DIVIDE_STRING_SUCCESS", "DIVIDE_STRING_FAIL", "BI_SET_DIVIDE_STRING_SUCCESS", "BI_SET_DIVIDE_STRING_FAIL"},
                                      {"PRINT_FAIL", "PRINT_NULL"},
                                      {},
                                      {"Test_FAIL", "Test_SUCCESS", "Test_BI_NEW_DELETE_SUCCESS", "Test_BI_NEW_DELETE_FAIL", "Test_BI_SET_FROM_SUCCESS", "Test_BI_SET_FROM_FAIL", "Test_Bigint_ALLOC_FAIL", "Test_BI_GET_RANDOM_SUCCESS","Test_BI_GET_RANDOM_FAIL"}};
