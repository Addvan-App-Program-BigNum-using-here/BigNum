...
static char *error_msg_list[6][10] = {{"SUCCESS", "FAIL"},
                                      ...
                                      {"RANDOM_SUCCESS", "RANDOM_FAIL", "BI_SET_REFINE_SUCCESS", "BI_SET_REFIEN_FAIL", "DIVIDE_STRING_SUCCESS", "DIVIDE_STRING_FAIL", "BI_SET_DIVIDE_STRING_SUCCESS", "BI_SET_DIVIDE_STRING_FAIL"},
